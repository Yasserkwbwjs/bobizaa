...
let tags = {
  'امتحنات':'‎أوامر لي الامتحانات',
  'تحميل تطبيقات':'‎ أوامر التطبيقات‎',
  'الصورة':'‎ توليد الصور‎ أوامر' ,
  'نيزكو':'‎ الذكاء الاصطناعي‎ أوامر',
  'البوت':'‎ معلومات البوت‎',
  'downloader':'‎ أوامر التحميلات',
  'الانمي':'‎ أوامر عن  الأنيم',
  'الاسلام':'‎ الدين هو الاسلام‎',
  'اوتشيها ديابلو':'‎ اوامر صاحب البوت',
  'بحث':'‎ أوامر البحث',
  'تعديل صوت':'‎ تعديل الصوتيات‎',
  'الملصقات':'‎ أوامر الملصقات',
  'تعديل على صور':'‎ تعديل الصور',
  'جيبي تي':'‎ pdf ومشتقاته‎',
  'ارشيف':'‎‎ رفع الملفات‎',
}
const defaultMenu = {
  before: `السلام عليكم 👋. 
