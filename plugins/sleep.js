...
let handler = async (m, { conn, text }) => {
    ...
    if (who) {
        ...
        let sir = await img.composite(avatar.resize(128, 128), 120, 90, {
            mode: 'dstOver',
            opacitySource: 1,
            opacityDest: 1
        }).getBufferAsync('image/png');
        conn.sendMessage(m.chat, { image: sir }, { quoted: m, contextInfo: { mentionedJid: [who] } });
    } else {
        ...
        conn.sendMessage(m.chat, { image: sir }, { quoted: m });
    }
}
